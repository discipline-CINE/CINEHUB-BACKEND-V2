...
public class QChatRoom extends EntityPathBase<ChatRoom> {
    ...
    public QChatRoom(Class<? extends ChatRoom> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new Discipline.CineHub.entity.QUserEntity(forProperty("member"), inits.get("member")) : null;
        this.other = inits.isInitialized("other") ? new Discipline.CineHub.entity.QUserEntity(forProperty("other"), inits.get("other")) : null;
    }
